...
class TMDBApi {
    ...
    async fetchData(endpoint, params = {}) {
        ...
        if (!isApiKeyConfigured()) {
            throw new Error('Clé API non configurée. Veuillez ajouter votre clé API dans js/config.js');
        }
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.status_message || `Erreur HTTP: ${response.status}`);
            }
