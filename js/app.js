...
console.log('%c🎬 TMDB Explorer', 'font-size: 24px; font-weight: bold; color: #01b4e4;');
console.log('%cApplication initialisée avec succès!', 'color: #90cea1;');
console.log('%cN\'oubliez pas de configurer votre clé API dans js/config.js', 'color: #ff6b6b;');
